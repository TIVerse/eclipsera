...
def test_pipeline_fit_transform(binary_classification_data):
    ...
    pipe = Pipeline([("scaler1", StandardScaler()), ("scaler2", MinMaxScaler())])
...
def test_pipeline_verbose(binary_classification_data, capsys):
    ...
    pipe = Pipeline(
        [("scaler", StandardScaler()), ("clf", LogisticRegression(max_iter=100))], verbose=True
    )
...
def test_pipeline_error_invalid_step():
    ...
    with pytest.raises(TypeError):
        Pipeline([("invalid", InvalidTransformer()), ("clf", LogisticRegression())])
...
def test_feature_union_basic():
    ...
    union = FeatureUnion([("scaler1", StandardScaler()), ("scaler2", MinMaxScaler())])
...
def test_feature_union_in_pipeline(binary_classification_data):
    ...
    pipe = Pipeline([("union", union), ("clf", LogisticRegression(max_iter=100))])
...
def test_feature_union_get_params():
    ...
    union = FeatureUnion([("scaler1", StandardScaler(with_std=True)), ("scaler2", MinMaxScaler())])
...
def test_feature_union_verbose(capsys):
    ...
    union = FeatureUnion([("scaler1", StandardScaler()), ("scaler2", MinMaxScaler())], verbose=True)
